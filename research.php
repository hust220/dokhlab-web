...
<table id="menu" width="800" height="30" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td>
			<a href=publications.php onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('menu_a_08','','menuimages/menu_h_08.jpg',1);">
...
<script type="text/javascript">
	...
	<div class=container>
      ...
      <div class="cfloat"></div>
			...
			<div id=divtopic1 style="margin: 5px; padding: 5px 10px 5px 10px; height=800px; width=750px; border: 1px solid #BBBBBB; display: none; overflow: hidden; visibility: visible">
			        <div >	   
			...
			<div id=divtopic2 style="margin: 5px; padding: 5px 10px 5px 10px; width=750px; border: 1px solid #BBBBBB; display: none; overflow: hidden; visibility: visible">
				<div >
                                      <p align="justify">
...
class="lytebox" data-title="<bold>Figure 2.             Molecular docking.</bold> Comparison between the lowest
			...
			<div id=divtopic3 style="margin: 5px; padding: 5px 10px 5px 10px; width=750px; border: 1px solid #BBBBBB; display: none; overflow: hidden; visibility: visible">
				<div >	   
			...
			<div class=spacer10></div>
                        ...
                        <div id=divtopic4 style="margin: 5px; padding: 5px 10px 5px 10px; width=750px; border: 1px solid #BBBBBB; display: none; overflow: hidden; visibility: visible">
                            <div >
                               <div class="blurb-figure">           
			...
			<div id=divtopic5 style="margin: 5px; padding: 5px 10px 5px 10px; width=750px; border: 1px solid #BBBBBB; display: none; overflow: hidden; visibility: visible">
				<div >
				   <div class="blurb-figure">	   
			...
			<div id=divtopic6 style="margin: 5px; padding: 5px 10px 5px 10px; width=750px; border: 1px solid #BBBBBB; display: none; overflow: hidden; visibility: visible">
				<div >
				   <div class="blurb-figure">
			...
			<div id=divtopic7 style="margin: 5px; padding: 5px 10px 5px 10px; width=750px; border: 1px solid #BBBBBB; display: none; overflow: hidden; visibility: visible">
				<div >
			...
			<div id=divtopic8 style="margin: 5px; padding: 5px 10px 5px 10px; width=750px; border: 1px solid #BBBBBB; display: none; overflow: hidden; visibility: visible">
				<div >
			...
			<div class=spacer10></div>
					...
					<div style="width:80px; font-family: Geneva, arial, sans-serif; font-size: 12px;position:relative; margin: 5px 0px 0px 722px;"><a id=maintext href=research.2.php>Expand all...</a></div>
		</div>
