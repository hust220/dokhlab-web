...
<!-- END COMMENT THE ADD-->
				...
				<div class=spacer10></div>
				<font size=4><b>P</font>ostdoctoral position in computational biophysics and drug discovery</b> 
				<div class=spacer10></div>
        
				<div class=spacer10></div>
        <font size=4>T</font>he Dokholyan Laboratory invites applications for a postdoctoral researcher in the field of computational biophysics to develop novel software tools for integrated computational and experimental drug discovery. The candidate should have experience in the fields of statistical physics, biophysics, and computer science. Required skills include high-level C++ programming experience, advanced object-oriented design knowledge, an understanding of Molecular Dynamics simulation techniques and software, and fluency in the Linux platform. The ideal candidate will have experience working in a programming team and managing multi-developer projects, preferably in the development of parallelized Molecular Dynamics simulation software. 
        <div class=spacer10></div>
				<div class=spacer10></div>
				<font size=4>U</font>NC and the Dokholyan Laboratory are committed to employing under-privileged minorities and individuals with disabilities. We seek to increase the number of females in the STEM fields, and women are strongly encouraged to apply. Please click <a id=maintext href=https://unc.peopleadmin.com/postings/46079 target=_blank> here to apply</a>.
				<div class=spacer10></div>
