...
<div class=spacer10></div>
<!-- Tool 8 -->
<img src=images/collapse.gif id=imgtopic8 style="cursor:pointer;" border=0 onclick="slide_topic8.slideIt();"> <strong>SPELL</strong>
<div id=divtopic8 style="margin: 5px; padding: 5px 10px 5px 10px; width=750px; border: 1px solid #BBBBBB; display: block;">
<div>      
<p><a href="/spell" target=_blank><img style="border: 1px dotted #AAAAAA; padding: 3px 3px 3px 3px;" src=images/SPELL_PIC.jpg align=right width=225 height=150></a>SPELL (Split Protein rEassembly by Ligand or Light) is a web server for predicting potential split sites in proteins. Reassembly of split protein can be controlled by ligand or light. This is achieved by fusing halves of split protein to two other domains, whose dimerization is controlled by ligand or light.</p>
<p>For details of the method, please refer to the paper: Computational design of regulatable split proteins with reduced background activity : Onur Dagliyan, Andrey Krokhotin, Alexander Deiters, Klaus M. Hahn, Nikolay V. Dokholyan (submitted)</p>
</div>
</div>
<script type=text/javascript>
